...
export default class Nav extends Component {
    ...
    <div className="nav-wrapper" ref={this.navWrapper} >
        <nav>
            ...
            <div className={(!this.state.toggledMenu)? "nav-links" : "nav-links full-menu"}>
                <div className={(!this.state.toggledMenu)? "nav-shape" : "nav-shape full-menu"} />
                <div className="menu" onClick={this.handleMenuClick}>
                    <i className={(!this.state.toggledMenu)? "fa fa-bars" : "fa fa-times"} aria-hidden="true" />
                </div>
