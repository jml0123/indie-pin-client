...
export default class ArtistCard extends Component {
    ...
    render(){
        ...
        const popStyle = (!this.props.data) ? null : {transform: `scale(${0.66  + this.props.data.popularity/133})`}
            ...
            <div className="artist-card">
                ...
                <div className="artist-card-header">
                    <div className="artist-img-wrapper">
                        <img src={(!this.props.data) ? null : this.props.data.profile_img} alt={(!this.props.data) ? null : this.props.artist_name + " spotify profile img"}/>
                    </div>
                    <div className="artist-locale-container">
                        <h1>{(!this.props.data) ? null : this.props.data.neighborhood}</h1>
                    </div>
                    <h1 className="artist-name">{(!this.props.data) ? null : this.props.data.artist_name}</h1>
